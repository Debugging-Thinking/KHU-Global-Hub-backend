...
public enum ErrorCode {
    ...
    INVALID_EMAIL_DOMAIN(HttpStatus.BAD_REQUEST, "@khu.ac.kr 이메일만 사용합니다."),
    ...
    POST_UNAUTHORIZED(HttpStatus.FORBIDDEN, "게시글의 수정/삭제 권한이 없습니다."),

    COMMENT_NOT_FOUND(HttpStatus.NOT_FOUND, "존재하지 않는 댓글입니다."),
    COMMENT_UNAUTHORIZED(HttpStatus.FORBIDDEN, "댓글의 수정/삭제 권한이 없습니다."),

    QNA_NOT_FOUND(HttpStatus.NOT_FOUND, "존재하지 않는 Q&A입니다."),
    QNA_UNAUTHORIZED(HttpStatus.FORBIDDEN, "Q&A의 수정/삭제 권한이 없습니다."),
    ANSWER_NOT_FOUND(HttpStatus.NOT_FOUND, "존재하지 않는 답변입니다."),
    ANSWER_UNAUTHORIZED(HttpStatus.FORBIDDEN, "답변의 수정/삭제 권한이 없습니다."),
    ALREADY_ADOPTED(HttpStatus.CONFLICT, "이미 채택된 답변입니다."),
    ...
    ACTIVITY_UNAUTHORIZED(HttpStatus.FORBIDDEN, "멘토링 활동 기록에 접근 권한이 없습니다."),

    QNA_ALREADY_ADOPTED(HttpStatus.CONFLICT, "채택이 완료된 질문에는 더 이상 답변할 수 없습니다."),
    ANSWER_ALREADY_EXISTS(HttpStatus.CONFLICT, "이미 해당 질문에 답변하셨습니다."),
